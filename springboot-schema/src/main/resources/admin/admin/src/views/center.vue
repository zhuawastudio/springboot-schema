<template>
  <div>
    ...
    >  
     <el-row>
      <el-col :span="12">
        <el-form-item   v-if="flag=='laoren'"  label="老人账号" prop="laorenzhanghao">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='laoren'"  label="老人手机" prop="laorenshouji">
          <el-input v-model="ruleForm.laorenshouji"               placeholder="老人手机" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='laoren'"  label="积分" prop="jifen">
          <el-input v-model="ruleForm.jifen" readonly              placeholder="积分" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='laoren'"  label="老人住址" prop="laorenzhuzhi">
          <el-input v-model="ruleForm.laorenzhuzhi"               placeholder="老人住址" clearable></el-input>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'laoren' ==this.flag && this.ruleForm.laorenshouji&&(!isMobile(this.ruleForm.laorenshouji))){
        this.$message.error(`老人手机应输入手机格式`);
        return
      }
      if( 'laoren' ==this.flag && this.ruleForm.jifen&&(!isIntNumer(this.ruleForm.jifen))){
